...
import getopt
import sys
from Astar import Asearch
from biAstar import BiAs
from MM import MMs
...
def main():
    ...
    for i in range(0, len(start_states)):   
        ...
        cost, expanded_astar =None,None# Asearch(start,goal,gridded_map)# Replace None, None with a call to your implementation of A*
        ...
        cost, expanded_mm =MMs(start,goal,gridded_map)# Replace None, None with a call to your implementation of MM
        ...
        cost, expanded_biastar =None,None#BiAs(start,goal,gridded_map) # Replace None, None with a call to your implementation of Bi-A*
